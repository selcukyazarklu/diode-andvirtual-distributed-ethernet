...
set_property IOSTANDARD LVCMOS25 [get_ports RX_CHANNEL_UP]



#LED0 ve LED1
set_property PACKAGE_PIN C24 [get_ports {RX_LANE_UP}]
set_property IOSTANDARD LVCMOS25 [get_ports {RX_LANE_UP}]


set_property PACKAGE_PIN A23 [get_ports {RX_HARD_ERR}]
set_property IOSTANDARD LVCMOS25 [get_ports {RX_HARD_ERR}]
...
#set_property PACKAGE_PIN B1 [get_ports sfp_txn_2]
#set_property IOSTANDARD LVDS [get_ports sfp_txn_2]
#set_property PACKAGE_PIN B2 [get_ports sfp_txp_2]
#set_property IOSTANDARD LVDS [get_ports sfp_txp_2]
